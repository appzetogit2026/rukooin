  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        <DocItem id="ownershipProof" label="Property Ownership / Lease Agreement" required={true} />
        <DocItem id="fireSafety" label="Fire Safety Certificate" required={false} />
        <DocItem id="gstDetails" label="GST Registration" required={false} />
        <DocItem id="tourismReg" label="Tourism Registration" required={false} />
      </div>
...
export default StepHotelDocuments;
