...
const StepVillaDocuments = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-[#003836]">Legal & Property Documents</h2>
      ...
      <div className="bg-yellow-50 p-4 rounded-lg text-yellow-800 text-sm mb-4 border border-yellow-200">
        ⚠️ Please upload clear, legible images or PDFs of valid documents.
      </div>

      <div className="space-y-3">
        {renderDocUpload('ownershipProof', '📄 Ownership Proof (Title Deed / Tax Receipt)', true)}
        {renderDocUpload('govtRegistration', '🏛️ Government Registration (Property Tax / NOC)', true)}
        {renderDocUpload('localPermission', '✅ Local Permission / Tourism License', true)}
      </div>

      <div className="bg-blue-50 border border-blue-100 p-4 rounded-lg">
        <p className="text-sm text-blue-800">
          <strong>ℹ️ Verification Process:</strong> Our team will review these documents within 24-48 hours. You'll be notified once approved.
        </p>
      </div>
    </div>
  );
...
export default StepVillaDocuments;
