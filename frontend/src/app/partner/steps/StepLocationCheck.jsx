    ...
    return (
        <div ref={containerRef} className="pt-2 md:pt-10">
            ...
            <div className="flex flex-col gap-3">
                ...
                <div
                    onClick={handleGPS}
                    className="loc-card cursor-pointer p-5 rounded-2xl border border-gray-100 hover:border-black hover:shadow-md transition-all duration-300 flex flex-col items-center text-center gap-3 group bg-gray-50 active:scale-95 touch-manipulation"
                >
                    ...
                    <div>
                        <h3 className="text-base font-bold text-black leading-tight">Yes, I am at the property</h3>
                ...
                <div
                    ...
                    className={`loc-card cursor-pointer p-4 rounded-2xl border transition-all flex items-center gap-3 active:scale-95 touch-manipulation
                        ${formData.location?.type === 'manual' ? 'border-black bg-white ring-1 ring-black' : 'border-gray-200 bg-white'}`}
                >
                    <div className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center shrink-0">
                        <MapPin size={18} className="text-gray-900" />
                    </div>
                    <div>
                        <span className="block font-bold text-gray-900 text-sm">No, I will search manually</span>
