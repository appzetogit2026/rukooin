  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500">Upload required legal documents for verification</p>
      </div>

      <div className="bg-red-50 p-4 rounded-lg text-red-800 text-sm mb-4 border border-red-200">
        ⚠️ <strong>Important:</strong> All documents must be valid, clear, and legible. Resort listing will be approved only after document verification.
      </div>

      <div className="space-y-3">
        <h3 className="font-bold text-md text-gray-700 mt-4">Required Documents</h3>
        {renderDocUpload('resortLicense', '📜 Resort License / Tourism License', true)}
        {renderDocUpload('fireSafety', '🚒 Fire Safety Certificate', true)}
        {renderDocUpload('localAuthority', '✅ Local Authority Approval / NOC', true)}
      </div>

      <div className="bg-blue-50 border border-blue-100 p-4 rounded-lg">
        <p className="text-sm text-blue-800">
          <strong>ℹ️ Verification:</strong> Our compliance team will verify documents within 48-72 hours. You'll be notified via email once approved.
        </p>
      </div>
    </div>
  );
...
export default StepResortDocuments;
